...
public class RestCotroller4 {
	// http://localhost:8080/mvx/rest4/board/1
	// http://localhost:8080/mvx/rest4/board/2
	// http://localhost:8080/mvx/rest4/board/99
	// => board의 숫자를 id로 갖는 게시글을 가져오게 만들고 싶다
	...
	public String test3(@PathVariable ("id") int id, @PathVariable ("reviewId") int reviewId) {
		return id+": board3, " + reviewId+": reviewId";
	}
